...
class _HomePageState extends State<HomePage> {
  ...
  void _openCategory(String category) {
    ...
    Navigator.push(
      context,
      MaterialPageRoute(builder: (_) => SearchPage(initialQuery: category)),
    );
  }
              ...
              IconButton(
                icon: Container(
                  ...
                  decoration: BoxDecoration(
                    ...
                    borderRadius: BorderRadius.circular(10),
                    boxShadow: [
                      BoxShadow(color: _ink.withOpacity(.06), blurRadius: 8),
                    ],
                  ),
                  child: const Icon(
                        ...
                        [
                            ...
                            .map(
                              (cat) => Padding(
                                ...
                                child: _chip(cat, () => _openCategory(cat)),
                              ),
                            )
                            .toList(),
                  ),
  ...
  Widget _chip(String label, VoidCallback onTap) => GestureDetector(
    ...
    child: Container(
      ...
      decoration: BoxDecoration(
        ...
        boxShadow: [BoxShadow(color: _ink.withOpacity(.04), blurRadius: 6)],
      ),
      child: Text(
        label,
        style: const TextStyle(
          ...
          ClipRRect(
            ...
            child: Image.network(
              ...
              errorBuilder: (_, __, ___) => Container(
                ...
                height: 64,
                color: _blueLight,
                child: const Icon(Icons.book_rounded, color: _blue, size: 28),
              ),
            ),
          ),
          const SizedBox(width: 14),
