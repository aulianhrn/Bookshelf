...
class _SearchPageState extends State<SearchPage> {
  ...
  Future<void> _search(String val) async {
    ...
    try {
      final res = await OpenLibraryService.instance
          .searchBooks(query: q, limit: 20);
      if (!mounted) return;
      setState(() => books = res);
    } catch (e) {
      if (!mounted) return;
  ...
  void _clear() {
    ...
    setState(() { _hasSearched = false; books = []; _focused = false; });
  }

  Future<void> _loadHistory() async {
    final p = await SharedPreferences.getInstance();
    if (mounted) setState(() => recentSearches = p.getStringList(_prefKey) ?? []);
  }

  Future<void> _saveHistory(String q) async {
    final p = await SharedPreferences.getInstance();
    recentSearches.remove(q); recentSearches.insert(0, q);
            ...
            child: Row(children: [
              ...
              Expanded(child: Container(
                ...
                decoration: BoxDecoration(
                  ...
                  boxShadow: [BoxShadow(
                      color: _ink.withOpacity(.06), blurRadius: 10)]),
                child: TextField(
    ...
    child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
      if (recentSearches.isNotEmpty) ...[
        Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
          const Text('Pencarian terakhir', style: TextStyle(
        ...
        Wrap(spacing: 8, runSpacing: 6,
          children: recentSearches.map((item) => GestureDetector(
            onTap: () { _ctrl.text = item; _focus.unfocus(); _search(item); },
            child: Container(
              ...
              child: Row(mainAxisSize: MainAxisSize.min, children: [
                const Icon(Icons.history_rounded, size: 14, color: _muted),
      ...
      if (_focused) ...[
        const Text('Jelajah genre', style: TextStyle(
            fontSize: 16, fontWeight: FontWeight.w700, color: _ink)),
        ...
        GridView.builder(
          ...
          itemBuilder: (_, i) {
            ...
            return GestureDetector(
              onTap: () {
                _ctrl.text = g; _focus.unfocus(); _search(g);
              },
              child: Container(
                decoration: BoxDecoration(
                ...
                child: Center(child: Text(g, style: const TextStyle(
  ...
  Widget _buildResults() {
    ...
    if (books.isEmpty) return const Center(child: Column(
        ...
        return GestureDetector(
          ...
          child: Container(
            ...
            decoration: BoxDecoration(
              ...
              boxShadow: [BoxShadow(
                  color: _ink.withOpacity(.05), blurRadius: 10,
            ...
            child: Row(children: [
              ClipRRect(
                ...
                child: Image.network(b.coverUrl,
                  ...
                  errorBuilder: (_, __, ___) => Container(
                    width: 44, height: 60, color: _blueLight,
              ...
              Expanded(child: Column(
                ...
                Text([b.author,
                  if (b.firstPublishYear != null) '${b.firstPublishYear}']
                    .join(' · '),
